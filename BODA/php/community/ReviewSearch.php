...
<?php
    ...
    function msg($alert){
        echo "<p>총 ".$alert."건의 검색 결과가 있습니다.</p>";
    }
...
<?php
    ...
    if($page != 1){
        $prevPage = $page - 1;
        echo "<li><a href='ReviewSearch.php?page=1&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>처음으로</a></li>";
        echo "<li><a href='ReviewSearch.php?page={$prevPage}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>이전</a></li>";
    }
    ...
    if($page != $endPage){
        $nextPage = $page + 1;
        echo "<li><a href='ReviewSearch.php?page={$nextPage}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>다음</a></li>";
        echo "<li><a href='ReviewSearch.php?page={$ReviewCount}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>마지막으로</a></li>";
    }
