...
<body>
    ...
    <main id="infoType" class="info__wrap agree">
        <h2 class="agree_tit">SIGN UP</h2>
        <div class="info__inner">
            <form action="agreeInfoSave.php" name="join" method="post">
                <fieldset>
                    <article class="info1">
                        <legend class="login1">로그인 정보</legend>
                        <div>
                            <label for="youID">아이디</label>
                            <div class="IDbox">
                                <input type="ID" id="youID" name="youID" placeholder="아이디를 입력해 주세요." autocomplete="off" required>
                                <a class="#c" class="btn1 check" onclick="idChecking()">중복확인</a>
                                <p class="msg" id="youIDComment"></p>
                            </div>
                        </div>
                    ...
                    <article class="info2">
                        ...
                        <div>
                            <label for="youEmail">이메일</label>
                            <div class="IDbox">
                                <input type="email" id="youEmail" placeholder="이메일을 입력해 주세요." autocomplete="off" required>
                                <a class="#c" class="btn1 check" onclick="emailChecking()">중복확인</a>
                                <p class="msg" id="youEmailComment"></p>
                            </div>
                        </div>
            ...
            <a href="../create/createMember.php">가보자고</a>
        </div>
    </main>
    <!-- //main -->
