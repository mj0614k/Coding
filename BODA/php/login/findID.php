                    ...
                    <fieldset>
                        ...
                        <div class="find__tabContent">
                            <div class="find-tab E">
                                ...
                                <input type="email" class="youEmail" name="youEmail" placeholder="이메일을 입력해주세요." id="youEmail" required>
                            </div>
                            <div class="find-tab P hide">
                                <label for="youPhone">휴대폰 번호</label>
                                <input type="text" class="youPhone" name="youPhone" placeholder="휴대폰 번호를 입력해주세요." id="youPhone" required>
                            </div>
                        </div>
                    </fieldset>
                </form>
